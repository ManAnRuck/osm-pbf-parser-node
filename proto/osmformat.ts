...
export const HeaderBlock = {
    read(pbf: import("pbf"), end?: undefined) {
    ...
    _readField(tag: number, obj: { bbox: any; required_features: any[]; optional_features: any[]; writingprogram: any; source: any; osmosis_replication_timestamp: any; osmosis_replication_sequence_number: any; osmosis_replication_base_url: any; }, pbf: Pbf) {
    ...
    write(obj: { bbox: any; required_features: string | any[]; optional_features: string | any[]; writingprogram: any; source: any; osmosis_replication_timestamp: any; osmosis_replication_sequence_number: any; osmosis_replication_base_url: any; }, pbf: Pbf) {
...
export const HeaderBBox = {
    read(pbf: Pbf, end: any) {
        return pbf.readFields(HeaderBBox._readField, {left: 0, right: 0, top: 0, bottom: 0}, end);
    },
    _readField(tag: number, obj: { left: any; right: any; top: any; bottom: any; }, pbf: Pbf) {
    ...
    write(obj: { left: any; right: any; top: any; bottom: any; }, pbf: Pbf) {
...
export const PrimitiveBlock = {
    ...
    _readField(tag: number, obj: { stringtable: any; primitivegroup: any[]; granularity: any; lat_offset: any; lon_offset: any; date_granularity: any; }, pbf: Pbf) {
    ...
    write(obj: { stringtable: any; primitivegroup: string | any[]; granularity: number | undefined; lat_offset: any; lon_offset: any; date_granularity: number | undefined; }, pbf: Pbf) {
...
export const PrimitiveGroup = {
    ...
    _readField(tag: number, obj: { nodes: any[]; dense: any; ways: any[]; relations: any[]; changesets: any[]; }, pbf: Pbf) {
    ...
    write(obj: { nodes: string | any[]; dense: any; ways: string | any[]; relations: string | any[]; changesets: string | any[]; }, pbf: Pbf) {
...
export const StringTable = {
    ...
    _readField(tag: number, obj: { s: any[]; }, pbf: Pbf) {
        if (tag === 1) obj.s.push(pbf.readBytes());
    },
    write(obj: { s: string | any[]; }, pbf: Pbf) {
...
export const Info = {
    ...
    _readField(tag: number, obj: { version: any; timestamp: any; changeset: any; uid: any; user_sid: any; visible: any; }, pbf: Pbf) {
    ...
    write(obj: { version: number | undefined; timestamp: any; changeset: any; uid: any; user_sid: any; visible: any; }, pbf: Pbf) {
...
export const DenseInfo = {
    ...
    write(obj: { version: any; timestamp: any; changeset: any; uid: any; user_sid: any; visible: any; }, pbf: Pbf) {
...
export const ChangeSet = {
    ...
    _readField(tag: number, obj: { id: any; }, pbf: Pbf) {
        if (tag === 1) obj.id = pbf.readVarint(true);
    },
    write(obj: { id: any; }, pbf: Pbf) {
...
export const Node = {
    ...
    _readField(tag: number, obj: { id: any; keys: any; vals: any; info: any; lat: any; lon: any; }, pbf: Pbf) {
    ...
    write(obj: { id: any; keys: any; vals: any; info: any; lat: any; lon: any; }, pbf: Pbf) {
...
export const DenseNodes = {
    read(pbf: Pbf, end: any) {
        return pbf.readFields(DenseNodes._readField, {id: [], denseinfo: null, lat: [], lon: [], keys_vals: []}, end);
    },
    _readField(tag: number, obj: { id: any; denseinfo: any; lat: any; lon: any; keys_vals: any; }, pbf: Pbf) {
    ...
    write(obj: { id: any; denseinfo: any; lat: any; lon: any; keys_vals: any; }, pbf: Pbf) {
...
export const Way = {
    ...
    _readField(tag: number, obj: { id: any; keys: any; vals: any; info: any; refs: any; lat: any; lon: any; }, pbf: Pbf) {
        if (tag === 1) obj.id = pbf.readVarint(true);
        else if (tag === 2) pbf.readPackedVarint(obj.keys);
        else if (tag === 3) pbf.readPackedVarint(obj.vals);
        else if (tag === 4) obj.info = Info.read(pbf, pbf.readVarint() + pbf.pos);
    ...
    write(obj: { id: any; keys: any; vals: any; info: any; refs: any; lat: any; lon: any; }, pbf: Pbf) {
        if (obj.id) pbf.writeVarintField(1, obj.id);
        if (obj.keys) pbf.writePackedVarint(2, obj.keys);
        if (obj.vals) pbf.writePackedVarint(3, obj.vals);
        if (obj.info) pbf.writeMessage(4, Info.write, obj.info);
...
export const Relation = {
    ...
    _readField(tag: number, obj: { id: any; keys: any; vals: any; info: any; roles_sid: any; memids: any; types: any; }, pbf: Pbf) {
        if (tag === 1) obj.id = pbf.readVarint(true);
        else if (tag === 2) pbf.readPackedVarint(obj.keys);
        else if (tag === 3) pbf.readPackedVarint(obj.vals);
        else if (tag === 4) obj.info = Info.read(pbf, pbf.readVarint() + pbf.pos);
    ...
    write(obj: { id: any; keys: any; vals: any; info: any; roles_sid: any; memids: any; types: any; }, pbf: Pbf) {
        if (obj.id) pbf.writeVarintField(1, obj.id);
        if (obj.keys) pbf.writePackedVarint(2, obj.keys);
        if (obj.vals) pbf.writePackedVarint(3, obj.vals);
        if (obj.info) pbf.writeMessage(4, Info.write, obj.info);

...
export interface IPrimitiveBlock {
    stringtable: IStringTable;
    primitivegroup?: IPrimitiveGroup[];
    granularity?: number;
    lat_offset?: number;
    lon_offset?: number;
...
export interface IPrimitiveGroup {
    nodes?: INode[];
    dense?: IDenseNodes;
    ways?: IWay[];
    relations?: IRelation[];
...
export interface IDenseNodes {
    id?: number[];
    denseinfo?: IDenseInfo;
    lat?: number[];
    lon?: number[];
    keys_vals?: number[];
}
...
export interface IRelation {
    ...
    roles_sid?: number[];
    memids?: number[];
    types?: Relation_MemberType_Value[];
}

export type Relation_MemberType_Key = "NODE" | "WAY" | "RELATION";
export type Relation_MemberType_Value = 0 | 1 | 2;

export const HeaderBlock = {
    read(pbf: Pbf, end?: number): IHeaderBlock {
    ...
    write(obj: IHeaderBlock, pbf: Pbf): void {
...
export const HeaderBBox = {
    read(pbf: Pbf, end?: number): IHeaderBBox {
    ...
    write(obj: IHeaderBBox, pbf: Pbf): void {
...
export const PrimitiveBlock = {
    read(pbf: Pbf, end?: number): IPrimitiveBlock {
    ...
    write(obj: IPrimitiveBlock, pbf: Pbf): void {
...
export const PrimitiveGroup = {
    read(pbf: Pbf, end?: number): IPrimitiveGroup {
    ...
    write(obj: IPrimitiveGroup, pbf: Pbf): void {
...
export const DenseInfo = {
    read(pbf: Pbf, end?: number): IDenseInfo {
    ...
    write(obj: IDenseInfo, pbf: Pbf): void {
...
export const ChangeSet = {
    read(pbf: Pbf, end?: number): IChangeSet {
        return pbf.readFields(ChangeSet._readField, {id: 0}, end);
    },
    _readField(tag: number, obj: any, pbf: Pbf): void {
        if (tag === 1) obj.id = pbf.readVarint(true);
    },
    write(obj: IChangeSet, pbf: Pbf): void {
        if (obj.id) pbf.writeVarintField(1, obj.id);
    }
};

export const Node = {
    read(pbf: Pbf, end?: number): INode {
...
export const DenseNodes = {
    read(pbf: Pbf, end?: number): IDenseNodes {
    ...
    write(obj: IDenseNodes, pbf: Pbf): void {
...
export const Relation = {
    ...
    read(pbf: Pbf, end?: number): IRelation {
    ...
    write(obj: IRelation, pbf: Pbf): void {
        if (obj.id) pbf.writeVarintField(1, obj.id);
        if (obj.keys) pbf.writePackedVarint(2, obj.keys);
        if (obj.vals) pbf.writePackedVarint(3, obj.vals);
        if (obj.info) pbf.writeMessage(4, Info.write, obj.info);
...
} as { [K in Relation_MemberType_Key]: { value: Relation_MemberType_Value, options: any } }

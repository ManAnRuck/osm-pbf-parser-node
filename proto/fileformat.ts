...
export const Blob = {
    read(pbf: { readFields: (arg0: (tag: any, obj: any, pbf: any) => void, arg1: { raw_size: number; raw: null; data: null; zlib_data: null; lzma_data: null; OBSOLETE_bzip2_data: null; lz4_data: null; zstd_data: null; }, arg2: any) => any; }, end?: any) {
    ...
    _readField(tag: number, obj: { raw_size: any; raw: any; data: string; zlib_data: any; lzma_data: any; OBSOLETE_bzip2_data: any; lz4_data: any; zstd_data: any; }, pbf: { readVarint: (arg0: boolean) => any; readBytes: () => any; }) {
    ...
    write(obj: { raw_size: any; raw: any; zlib_data: any; lzma_data: any; OBSOLETE_bzip2_data: any; lz4_data: any; zstd_data: any; }, pbf: { writeVarintField: (arg0: number, arg1: any) => void; writeBytesField: (arg0: number, arg1: any) => void; }) {
...
export const BlobHeader = {
    read(pbf: { readFields: (arg0: (tag: any, obj: any, pbf: any) => void, arg1: { type: string; indexdata: null; datasize: number; }, arg2: any) => any; }, end?: any) {
        return pbf.readFields(BlobHeader._readField, {type: "", indexdata: null, datasize: 0}, end);
    },
    _readField(tag: number, obj: { type: any; indexdata: any; datasize: any; }, pbf: { readString: () => any; readBytes: () => any; readVarint: (arg0: boolean) => any; }) {
        if (tag === 1) obj.type = pbf.readString();
        else if (tag === 2) obj.indexdata = pbf.readBytes();
        else if (tag === 3) obj.datasize = pbf.readVarint(true);
    },
    write(obj: { type: any; indexdata: any; datasize: any; }, pbf: { writeStringField: (arg0: number, arg1: any) => void; writeBytesField: (arg0: number, arg1: any) => void; writeVarintField: (arg0: number, arg1: any) => void; }) {
